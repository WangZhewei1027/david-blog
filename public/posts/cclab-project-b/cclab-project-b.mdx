...
<Image src="/posts/cclab-project-b/main.png" alt="Main Interface" className="shadow-lg" height={400} width={400} />
...
<Image src="/posts/cclab-project-b/first_prototype.gif" className="shadow-lg" height={400} width={400} alt="First Prototype"/>
