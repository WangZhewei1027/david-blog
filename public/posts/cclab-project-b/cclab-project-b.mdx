...
type: article
pin: true
tags: coding, p5js, IMA, cclab
---

# Project B — Jumping Notes

<div className="flex flex-col justify-center mb-4">
    <Image src="/posts/cclab-project-b/main.png" className="shadow-lg" height={400} width={400} />
    <p className="text-center italic">Main Interface</p>
</div>

[Project Link](https://wangzhewei1027.github.io/CCLab/project%20B/)
...
<div className="flex flex-col justify-center mb-4">
    <Image src="/posts/cclab-project-b/first_prototype.gif" className="shadow-lg" height={400} width={400} />
    <p className="text-center italic">First Prototype</p>
</div>
