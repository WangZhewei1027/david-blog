...
<div className="flex justify-center mb-4">
    <video src="/posts/nime-w2-first-try/interaction.mp4" className="bg-gray-500" controls playsinline preload="metadata" width={400} height={400} />
</div>

<div className="flex justify-center mb-4">
    <video src="/posts/nime-w2-first-try/ableton.mov" className="bg-gray-500" controls playsinline preload="metadata" width={600} height={600} />
</div>
