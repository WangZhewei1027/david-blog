...
<div className="flex justify-center mb-4">
    <video src="/posts/nime-first-try/interaction.mp4" controls playsinline width={400} height={400} />
</div>

<div className="flex justify-center mb-4">
    <video src="/posts/nime-first-try/ableton.mov" controls playsinline width={600} height={600} />
</div>
